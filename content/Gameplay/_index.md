...
單位／{{<img width=20px height=26.58px src="images/typeArtifact.png">}}神器／ **先手** {{<img width=22.00px height=20.00px src="images/typeStrategem.png">}} **戰術牌（Stratagem）** 全部會佔位置。玩鋪場卡組時尤其要注意。
...
A. 99.999%係因為對面同一行既其他單位有{{<img width=20px height=20.80px src="images/statusDefender.png">}}衛士（Defender）狀態。

如果敵方某一行有{{<img width=20px height=20.80px src="images/statusDefender.png">}}衛士單位，咁你任何既 **指定效果** 都唔可以指定佢果一行既其他卡，只能指定佢。

現時每個陣營都有一張衛士，新手要花少少時間認住佢地。

{{<figure src="/images/defender.jpg">}}

用帶 **淨化（Purify）** 效果既卡（如 Geralt: Axii, Pellar），可以 **移除** {{<img width=20px height=20.80px src="images/statusDefender.png">}}衛士狀態。
...
| 狀態 |     列表      |
| :--: | :-----------: |
| 正面 | {{<img width=20px height=20.80px src="images/statusDefender.png">}}[衛士（Defender）](https://teamleviathangaming.com/glossary/defender/)、{{<img width=20px height=20.80px src="images/statusImmunity.png">}}[免疫（Immunity）](https://teamleviathangaming.com/glossary/immunity/)、{{<img width=20px height=20.80px src="images/statusResilience.png">}}[堅韌（Resilience）](https://teamleviathangaming.com/glossary/resilience/)、{{<img width=20px height=20.80px src="images/statusShield.png">}}[護盾（Shield）](https://teamleviathangaming.com/glossary/shield/)、{{<img width=12.1px height=23.80px src="images/statusVitality.png">}}[活力（Vitality）](https://teamleviathangaming.com/glossary/vitality/)|
| 負面 |{{<img width=20px height=20.80px src="images/statusPoison.png">}}[中毒（Poison）](https://teamleviathangaming.com/glossary/poison/)、{{<img width=20px height=20.80px src="images/statusBounty.png">}}[賞金（Bounty）](https://teamleviathangaming.com/glossary/bounty-status/)、{{<img width=20px height=20.80px src="images/statusLock.png">}}[鎖定（Lock）](https://teamleviathangaming.com/glossary/lock/)、{{<img width=12.1px height=23.80px src="images/statusBleeding.png">}}[重傷（Bleeding）](https://teamleviathangaming.com/glossary/bleeding-2/)、{{<img width=20px height=20.80px src="images/statusDoomed.png">}}[佚亡（Doomed）](https://teamleviathangaming.com/glossary/doomed/)、{{<img width=20px height=20.80px src="images/statusSpying.png">}}[潛伏（Spying）](https://teamleviathangaming.com/glossary/spying/)、{{<img width=20px height=20.80px src="images/statusRupture.png">}}[破裂（Rupture）](https://teamleviathangaming.com/glossary/rupture/)|

&nbsp;

{{<rawhtml>}}

<h4 id="q-進階玩法咩野係長局短局同埋點解咁重要">Q. {{<class name="AdvGP" text="（進階玩法）">}}咩野係{{<class name="bold" text="長局／短局">}}，同埋點解咁重要？ <span class="anchor" data-clipboard-text="/gameplay/#q-進階玩法咩野係長局短局同埋點解咁重要"><i class="fas fa-link fa-lg"></i></span>
</h4>
...
Q. {{<class name="AdvGP" text="（進階玩法）">}}咩野係{{<class name="bold" text="卡差（Card Advantage／CA）">}}？先手定後手著數啲？ <span class="anchor" data-clipboard-text="/gameplay/#q-進階玩法咩野係卡差card-advantageca先手定後手著數d"><i class="fas fa-link fa-lg"></i></span>
</h4>
...
Q. {{<class name="AdvGP" text="（進階玩法）">}}咩野係{{<class name="bold" text="最後一手（Last Say）">}}？ <span class="anchor" data-clipboard-text="/gameplay/#q-進階玩法咩野係最後一手last-say"><i class="fas fa-link fa-lg"></i></span>
</h4>
